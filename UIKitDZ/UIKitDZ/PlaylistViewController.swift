...
class PlaylistViewController: UIViewController {
    ...
    private var musicOne = Music(image: "Artists", title: "DIARO", description: "On The Way", time: "04:30", nameMusic: "01 On The Way")
    private var musicTwo = Music(image: "Queen", title: "Demeter", description: "Utopia", time: "03:49", nameMusic: "01 Utopia")
    ...
    @IBAction func showFirstSong(_ sender: Any) {
        transitionToMusic(music: Music(image: "Artists", title: "DIARO", description: "On The Way", time: "04:30", nameMusic: "01 On The Way"))
    }

    @IBAction func showTwoSong(_ sender: Any) {
        transitionToMusic(music: Music(image: "Queen", title: "Demeter", description: "Utopia", time: "03:49", nameMusic: "01 Utopia"))
    }
    ...
    private func transitionToMusic(music: Music) {
        ...
        musicViewController.music = Music(image: music.image, title: music.title, description: music.description, time: music.time, nameMusic: music.nameMusic)
